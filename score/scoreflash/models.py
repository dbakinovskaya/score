...
class Events(models.Model):
    ...
    fixture_id = models.ForeignKey('fixtures.Fixtures', on_delete=models.CASCADE)
...
class MatchesStatistics(models.Model):
    ...
    fixture_id = models.ForeignKey('fixtures.Fixtures', on_delete=models.CASCADE)
    home_team_id = models.ForeignKey(Teams, related_name='home_team', on_delete=models.CASCADE)
    away_team_id = models.ForeignKey(Teams, related_name='away_team', on_delete=models.CASCADE)
